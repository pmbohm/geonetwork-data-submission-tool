(ns metcalf.widget.boxmap-spec
  (:require [metcalf.widget.boxmap :as gmap]
            [metcalf.core-spec :as core]
            [cljs.spec :as s]
            [om.core :as om]
...
(s/fdef gmap/BoxMapWidget
  :args (s/cat :props (s/keys :req-un [::gmap/map-props ::gmap/on-change])
               :owner om/component?))
